...
7. Optional Microsoft 365 calendar (since 3.28): lets the user create
   ...
   delegated Calendars.ReadWrite + Calendars.ReadWrite.Shared only -
   own calendar and calendars shared with the user). Tokens stay in local storage and
