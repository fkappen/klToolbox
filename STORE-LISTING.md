...
| Host `raw.githubusercontent.com` | On explicit user action (options button), a static JSON configuration file (default settings) is fetched from the extension's public GitHub repository. No code is loaded, no data is transmitted. |
